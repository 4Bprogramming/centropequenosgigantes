...
function Texto() {
  return (
    <div>
     <h5 className={styles.sliderDescription} style={{fontStyle: "oblique", textAlign:"justify",padding:"10px"}} >Psicólogos. Te ayudamos en el camino a la solución de los problemas que no te dejan vivir. Psicólogos Profesionales. Te acompañamos en este proceso de cambio hasta que lo superes. Reserva Online. Horarios Flexibles. Servicios: Terapia Individual, Terapia Online.</h5><br />
