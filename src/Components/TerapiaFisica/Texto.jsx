...
function Texto() {
  return (
    <div>
     <h5 style={{fontStyle: "oblique",textAlign:"justify"}} >La terapia física (conocida comúnmente por sus siglas en inglés “PT”) es tratamiento que ayuda a mantener sus coyunturas y músculos trabajando como deben. La terapia física también se usa después de un accidente, cirugía o sangrado para volver a poner los músculos y coyunturas en forma.</h5><br />
