...
function EditorTexto({handleChange, handleSubmit, post}) {
  ...
  return (
    <Form className={styles.formContiner} >
        <Form.Label className={styles.paciente} >Nombre: {post.paciente}</Form.Label>
        <br/>
        <Form.Label className={styles.formLabel}>Documento N°: {post.documento}</Form.Label>
        <br/>
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
        <Form.Label className={styles.formLabel}>Detalle la consulta:</Form.Label>
        <Form.Control
        as="textarea" 
        rows={10} 
