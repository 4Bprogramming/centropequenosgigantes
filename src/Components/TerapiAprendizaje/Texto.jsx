...
function Texto() {
  return (
    <div>
     ...
     <p className={styles.sliderDescription} style={{textAlign:"justify"}} > Tiene como objetivo posibilitar el máximo desarrollo de las capacidades cognitivas de los niños y adolescentes para un aprendizaje significativo y funcional. </p>
         </div>
  )
}
